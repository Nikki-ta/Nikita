...
## LICENSE
This project is licensed under the MIT License - see the <a src="https://github.com/Nikki-ta/Sweet-Sage/blob/main/LICENSE.md" alt="LICENSE.MD" target="blank"> files for details.
